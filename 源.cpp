...
int main()
{
	...
	//int nx = jisuan_fu1.cols / 2;			//初始化频谱图的横纵坐标
	//int ny = jisuan_fu1.rows / 2;

	//Mat t0(planes[0], Rect(0, 0, nx, ny));       //左上角图像划定ROI区域
	//Mat t1(planes[0], Rect(nx, 0, nx, ny));      //右上角图像
	//Mat t2(planes[0], Rect(0, ny, nx, ny));      //左下角图像
	//Mat t3(planes[0], Rect(nx, ny, nx, ny));     //右下角图像
